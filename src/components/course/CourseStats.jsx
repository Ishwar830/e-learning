...
export default function CourseStats({rating, studentsEnrolled, tag, level}) {
   ...
   return (
      <div className="flex flex-wrap gap-4 text-sm text-slate-800">
         <span
            className={`${tagStyles[tag]} flex items-center font-bold border p-1 rounded-sm border-slate-400`}
         >
            {tag}
         </span>
         ...
         <span className="flex items-center border p-1 rounded-sm border-slate-400 ">
